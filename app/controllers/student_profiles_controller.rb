class StudentProfilesController < ApplicationController
  ...
  def create
    ...
    if @student_profile.save
      redirect_to @student_profile, notice: 'Student profile was successfully created.'
    else
      render :new
    end
  end
  ...
  def destroy
    ...
    redirect_to student_profiles_url, notice: 'Student profile was successfully destroyed.'
  end
